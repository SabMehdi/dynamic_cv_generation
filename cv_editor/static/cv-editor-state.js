...
export const PDF_FONT_DEFAULTS = {
  ...
  exp_company_title: { size: 10, style: "B", cell_h: 5, color: "#000000" },
  exp_company_period: { size: 8, style: "I", cell_h: 5, color: "#000000" },
...
export const PDF_FONT_KEYS = [
  ...
  { group: "Experience", key: "exp_company_title", label: "Company title", line: false, cell: true, color: true },
  { group: "Experience", key: "exp_company_period", label: "Company period", line: false, cell: true, color: true },
  { group: "Experience", key: "exp_item_title", label: "Mission title", line: false, cell: true, color: true },
  { group: "Experience", key: "exp_item_date", label: "Mission date (right)", line: false, cell: true, color: true },
